...
urlpatterns = [
    ...
    path('formulaires/<int:formulaire_id>/champs/', views.ChampFormulaireGestionView.as_view(), name='champ-create'),
    path('champs/<int:pk>/', views.ChampFormulaireDetailView.as_view(), name='champ-detail'),
